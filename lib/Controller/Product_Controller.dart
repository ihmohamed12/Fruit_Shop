...
class ProductController extends GetxController {
  var weight =0.obs;
  List<Product> item=[];
  Product current=  Product(weight: 0,imagePath: "",description: "",calories: 0,
      price: 0,type: "",name: "",rating: 0);
  ...
  setCurrentProduct(Product currentProduct){
    current=  Product(rating:currentProduct.rating ,
        name:currentProduct.name, type:currentProduct.type,price: currentProduct.price,calories: currentProduct.calories,description: currentProduct.description,imagePath: currentProduct.imagePath,weight: currentProduct.weight );
  }
